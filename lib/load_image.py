...
parser = argparse.ArgumentParser(
  description='Loads an image file, converts it to RGB format and displays it on the LED matrix. The image must be 8 x 8 pixels in size.'
)
parser.add_argument(
  'file_path',
  type=str,
